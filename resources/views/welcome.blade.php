...
<head>
    ...
    <link rel="shortcut icon" href="images/logoEOP1.ico">
...
<div style="top: 0px; position: relative;" class="templatemo-top-menu stuckMenu">
    <div class="container">
        <!-- Static navbar -->
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                    <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                        ...
                        <li class=""><a href="#templatemo-services">Nos services</a></li>
                        <li class=""><a href="#templatemo-partners">Nos partenaires</a></li>
                        <li><a href="#templatemo-team">L'équipe</a></li>
                        <li><a href="#templatemo-inscription">Developpeurs</a></li>
                        <li><a href="#templatemo-contact">Contacts</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div><!--/.container-fluid -->
        </div><!--/.navbar -->
...
<div style="margin-top: 0px;">
    ...
    <div id="templatemo-carousel" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            <li data-target="#templatemo-carousel" data-slide-to="0" class=""></li>
            <li class="active" data-target="#templatemo-carousel" data-slide-to="1"></li>
            <li class="" data-target="#templatemo-carousel" data-slide-to="2"></li>
        </ol>
        <div class="carousel-inner">
            <div class="item  active">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>BIENVENUE SUR EOP</h1>
                        <p>Effectuez vos paiements en ligne avec Easy Online Paiement</p>
                        <p>
                            <a class="btn btn-lg btn-green" href="#templatemo-inscription" role="button" style="margin: 20px;">S'inscrire</a>
                            <a class="btn btn-lg btn-orange" href="#" role="button">Se connecter</a>
                        </p>
                    </div>
                </div>
            </div>
...
<div class="templatemo-services" id="templatemo-services">
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    <div>
                        ...
                        <span class="templatemo-service-item-header">Paiemente</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    <div>
                        ...
                        <span class="templatemo-service-item-header">Transferts </span>
                    </div>
                    <p>Urbanic is a responsive Bootstrap template by templatemo for free download. Credits go to <a rel="nofollow" href="http://getbootstrap.com" target="_parent">Bootstrap</a> and <a rel="nofollow" href="http://unsplash.com" target="_parent">Unsplash</a> for images used in this template. You do not need to put a credit link back. Curabitur non eros ut dolor tincidunt interdum sit amet vitae quam.</p>
                    <div class="text-center">
                        <a href="#" class="templatemo-btn-read-more btn btn-orange">READ MORE</a>
                    </div>
                    <br class="clearfix">
            ...
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    <div>
                        ...
                        <span class="templatemo-service-item-header">Intégration APIs</span>
                    </div>
...
<div id="templatemo-partners">
    <div class="container">
        <div class="row">
            <div class="templatemo-line-header">
                <div class="text-center">
                    <hr class="team_hr team_hr_left hr_gray"><span class="txt_darkgrey">NOS SOUTIENS</span>
                    <hr class="team_hr team_hr_right hr_gray">
                </div>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="text-center">
            <ul class="templatemo-project-gallery">
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-graphic">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-1.jpg" data-group="gallery-graphic">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-creative">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-2.jpg" data-group="gallery-creative">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-3.jpg" data-group="gallery-inspiration">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-design">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-4.jpg" data-group="gallery-design">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-5.jpg" data-group="gallery-inspiration">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-6.jpg" data-group="gallery-inspiration">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-design">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-7.jpg" data-group="gallery-design">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-creative">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-8.jpg" data-group="gallery-creative">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-graphic">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-9.jpg" data-group="gallery-graphic">
                        <div class="templatemo-project-box">
                ...
                <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-inspiration">
                    <a class="colorbox cboxElement" href="images/full-gallery-image-10.jpg" data-group="gallery-inspiration">
                        <div class="templatemo-project-box">
...
<div class="templatemo-team" id="templatemo-team">
    <div class="container">
        <div class="row">
            <div class="templatemo-line-header">
                <div class="text-center">
                    <hr class="team_hr team_hr_left"><span>NOTRE EQUIPE</span>
                ...
                <div class="text-center">
                    <div class="member-thumb">
                        ...
                        <div class="thumb-overlay">
                            <a rel="nofollow" href="http://www.facebook.com/templatemo" class="external-link" target="_parent"><span class="social-icon-fb"></span></a>
            ...
            <div class="col-md-4 contact_right">
                ...
                <form class="form-horizontal" action="#">
                    <div class="form-group">
                        <input class="form-control" placeholder="Your Name..." maxlength="40" type="email">
                    </div>
                    <div class="form-group">
                        <input class="form-control" placeholder="Your Email..." maxlength="40" type="email">
                    </div>
                    <div class="form-group">
